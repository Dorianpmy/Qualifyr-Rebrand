...
Statuts : `idée`, `à préparer`, `prêt`, `publié`. Aucun chiffre ni résultat ne doit être inventé.

| Sujet | Audience | Problème | Angle | Page cible | CTA | Preuve | Statut |
|---|---|---|---|---|---|---|---|
| Rendre trois formules de nettoyage comparables | Nettoyage auto | Formules confuses | Montrer une hiérarchie simple | `/nettoyage-automobile` | Faire le diagnostic | SW Car Cleaning | idée |
| Présenter une zone d’intervention sans perdre le client | Nettoyage auto | Doute sur la couverture | Répondre avant le premier message | `/nettoyage-automobile` | Présenter mon activité | SW Car Cleaning | idée |
...
| Préparer un projet avant de demander un devis | Services | Besoin imprécis | Questions essentielles | `/diagnostic` | Faire le diagnostic | Diagnostic | idée |
