  ...
  return (
    ...
    >
      ...
      <SubscribeButton
        ...
        className={
          plan.featured
            ? 'cta-solid inline-flex min-h-[44px] w-full items-center justify-center rounded-full bg-white px-5 text-center text-[0.875rem] font-semibold text-ink no-underline transition-colors duration-150 hover:not-disabled:bg-white/90 disabled:cursor-not-allowed disabled:opacity-70'
